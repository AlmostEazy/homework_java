...
public class program {
    private Set<laptopPC> notebooks = new HashSet<>();
    ...
    public boolean notebookIsCorrect(laptopPC notebook) {
    ...
    public program(Set<laptopPC> notebooks) {
        this.sc = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public program(Set<laptopPC> notebooks, List<Criterion> criterionList) {
        this.sc = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public int getCriteria() {
        String text = "Введите цифру, соответствующую критерию поиска: ";
